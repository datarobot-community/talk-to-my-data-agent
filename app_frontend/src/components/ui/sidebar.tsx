    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            `
              fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) ease-linear
              md:flex
            `,
            side === 'left'
              ? `
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={cn(
          `
          absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 ease-linear
    ...
    return (
      <main
        ...
        className={cn(
          ...
          md:peer-data-[variant=inset]:shadow-sm md:peer-data-[state=collapsed]:peer-data-[variant=inset]:ml-2
        `,
          className
        )}
        {...props}
...
const sidebarMenuButtonVariants = cva(
  ...
  ),
  {
    variants: {
      ...
      isActive: {
        true: 'rounded-l-none border-l-2 border-l-accent',
      },
    },
    defaultVariants: {
      variant: 'default',
  ...
  (
    ...
    const button = (
      <Comp
        ...
        disabled={disabled}
        className={cn(sidebarMenuButtonVariants({ variant, size, disabled, isActive }), className)}
        {...props}
      />
    );
